...
_IG_Drag.prototype.cacheTargets = function() {
  ...
  for (var id in this.target_) {
    this.targetLeft_[id] = _IG_DragPosition_left(this.target_[id])
                           - this.leftMargin;
    this.targetRight_[id] = _IG_DragPosition_right(this.target_[id])
                            + this.rightMargin;
    this.targetTop_[id] = _IG_DragPosition_top(this.target_[id])
                          - this.topMargin;
    this.targetBottom_[id] = _IG_DragPosition_bottom(this.target_[id])
                           + this.bottomMargin;
  }
}
...
_IG_Drag.prototype.makeCallbackFunctions = function() {
  ...
  this.dragStart = function(e) {
    ...
    if (typeof(cbthis.curSource._IG_DragSurrogateView) != 'undefined') {
    ...
    if (e.which && e.which == 3) cbthis.isRightButton = true;
  ...
  this.dragEnd = function() {
    ...
    if (cbthis.curSource != null) {
      cbthis.onDragEnd(cbthis.curSource,
                              cbthis.target_[cbthis.curTargetId]);
      if (!hd) {
